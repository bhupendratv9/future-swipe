...
import { Form, Field, RadioGroup, Radio, Select } from "@base-ui/react";
...
function RouteComponent() {
  ...
  const handleBack = () => {
    router.navigate({
      to: "/profile",
      replace: true, // THIS removes update page from history
    });
  };
      ...
      <Header
        left={
          <div className="flex gap-3 items-center">
            ...
            />
            <p className="h2">{pageContent?.personalInfo?.edit}</p>
          </div>
        }
      />
      <Vstack size="sm">
        <Container className="max-w-120">
          <div className="max-w-93 mx-auto w-full">
            <Form
              onSubmit={(e) => {
                e.preventDefault();
                form.handleSubmit();
                          ...
                          return (
                            ...
                            >
                              ...
                              <Field.Control
                                ...
                                placeholder={
                                  pageContent?.personalInfo?.fields.name
                                    .placeholder
                                }
